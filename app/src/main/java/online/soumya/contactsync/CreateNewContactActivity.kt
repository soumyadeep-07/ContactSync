...
//            try {
//                imageUri?.let { imageRef.putFile(it).await() }
...
//                e.printStackTrace()
//                withContext(Dispatchers.Main) {
//                    Toast.makeText(this@CreateNewContactActivity, "Image Upload not successful", Toast.LENGTH_SHORT).show()
//                }
//            }
//        }
//    }
//
//    private fun saveContactToDatabase(contact: Contact) {
//        val databaseReference = Firebase.database.reference.child("user_data").child(Firebase.auth.currentUser!!.uid)
//        try {
//            databaseReference.push().setValue(contact).addOnSuccessListener {
//                binding.transpreant.visibility = View.GONE
//                binding.progressBar.visibility = View.GONE
//                Toast.makeText(this, "Contact is Saved", Toast.LENGTH_SHORT).show()
//                openMainActivity()
...
class CreateNewContactActivity : AppCompatActivity() {
    ...
    private suspend fun uploadImageAndSaveContact() {
        binding.transpreant.visibility = View.VISIBLE
        binding.progressBar.visibility = View.VISIBLE
